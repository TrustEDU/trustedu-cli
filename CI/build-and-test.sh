#!/bin/bash
#
# This script builds trustedu-cli with dotnet 2.0, and runs the tests.
#
CONTAINER_NAME="trustedu-cli-ci"
...
# Build the Docker image (includes building the current trustedu-cli code)
